...
void alg() {
   ...
   // cout << n << " and " << m << endl;
    ...
    for (int i = 0; i < n; ++i) {
        ...
        int w = x - y;
        for (int j = 0; j < 4; ++j) {
            cout << "Adding point " << w << ", " << v << " to helper " << j
            << " original x " << x << " y " << y << endl;
    ...
    for (int i = 0; i < 4; ++i) {
        ...
        for (int j = 0; j < sz; ++j) {
            ...
            cout << "hull point " << helpers[i].points[j].x
            << ", " << helpers[i].points[j].y << endl;
    ...
    FORE (it, events) {
        ...
        cout << "Setting best[" << it->index << "] to (" << it->choice->x
        << ", " << it->choice->y << ")" << endl;
        ...
        for (int k = max(1, m - 3); k <= m; ++k) {
            ...
            cout << "Result is " << sqrtl(sx * (LD) sx + sy * (LD) sy) << endl;
