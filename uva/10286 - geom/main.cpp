...
int main() {
	...
	while(1 == scanf("%lf", &sPent))
	{
		double pentIntAng = (3 * pi) / 5;
		
		double smallAng = (pentIntAng - pi /2) / 2;
		
		double thirdAng = pi - pentIntAng - smallAng;
		
		//cout << sPent / sin(thirdAng) << endl;
		//cout << sin(pentIntAng) << endl;
		double sqSide =  sPent / sin(thirdAng) * sin(pentIntAng);
